 ...
 *
 * Avatar images are fetched automatically from Cloudinary by matching
 * each member's name (lowercase) against the image public_id.
 * Upload a photo named e.g. "neelima babber" via /admin → it appears here.
 */
export const STATIC_MEMBERS = [
  ...
  },
  {
    ...
    icon: '📐',
    description:
      'Bhup Singh creates and grades every pattern with precision to ensure the perfect fit, comfort, and silhouette across all Qurvii sizes.',
  ...
  },
  {
    ...
    icon: '🪡',
    description:
      'Idrees Miyan brings new patterns to life by stitching the very first sample garment, helping transform ideas into wearable designs.',
 ...
 *
 * Avatar images are fetched automatically from Cloudinary by matching
 * the resolved name (lowercase) against the image public_id.
 * This works for both fixed defaults and dynamic names from scans.
 *
...
export const TEAM_ROLES = [
  ...
  },
  {
    ...
    defaultName: 'Satendra Kumar Soni',
    icon: '🔍',
    description: (name) =>
